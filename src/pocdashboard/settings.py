"""
Django settings for pocdashboard project.
...
CSRF_TRUSTED_ORIGINS = ['app-pocdashboard.azurewebsites.net', "127.0.0.1"]
...
ROOT_URLCONF = 'pocdashboard.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "pocdashboard/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'pocdashboard.wsgi.application'
